...
void HSLNode::setHSL(float h , float s, float l) {
    m_dH = h;
    m_dS = s;
    m_dL = l;
    updateHSL();
}
void HSLNode::updateHSL() {
...
void HSLNode::setH(float h){
    m_dH = h;
    updateHSL();
}
void HSLNode::setS(float s){
    m_dS = s;
    updateHSL();
}
void HSLNode::setL(float l){
    m_dL = l;
    updateHSL();
}
